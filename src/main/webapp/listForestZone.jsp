...
<html lang="es">
    <head>
        ...
        <style>
            ...
            body {
                background-image: url('Images/listForestZone.jpg');
        ...
        <div class="container py-5">
            ...
            <div class="card shadow-sm border-success">
                <div class="card-header bg-success text-white">
                    <i class="fas fa-list me-1"></i> Registros de Zonas Forestales
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <c:forEach var="zone" items="${listForestZone}">
                                    <tr>
                                        <td>${zone.id}</td>
                                        ...
                                        <td class="action-btns">
                                            <div class="d-flex flex-column gap-2">
                                                <a href="ForestZone?option=update&id=${zone.id}" 
                                                   class="btn btn-sm btn-outline-success">
                                                    <i class="fas fa-edit me-1"></i> Editar
                                                </a>
                                                <a href="ForestZone?option=delete&id=${zone.id}" 
                                                   class="btn btn-sm btn-outline-danger"
                                                   onclick="return confirm('¿Seguro que desea eliminar esta zona forestal?');">
